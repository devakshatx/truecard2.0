...
const ProductSidebarLayout = ({ productState, setProductState, direction }) => {
  return (
    ...
    >
        ...
        <Row>
          {direction == "left" && (
            <ProductDetailSidebar
              customClass={"collection-filter product-sidebar-box"}
          ...
          {direction == "right" && (
            <ProductDetailSidebar
              customClass={"product-sidebar-box"}
              productState={productState}
            />
          )}
        </Row>
      ...
      <WrapperComponent
        classes={{
          sectionClass: "tab-product product-details-contain m-0",
      ...
      {productState?.product?.related_products?.length > 0 && (
        <RelatedProduct
          customContainerClass="section-t-space"
          productState={productState}
          setProductState={setProductState}
        />
      )}
